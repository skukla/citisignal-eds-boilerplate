...
import { commerceEndpointWithQueryParams, rootLink, encodeSkuForUrl } from '../../scripts/commerce.js';
...
export default async function decorate(block) {
  ...
  await wishlistRenderer.render(Wishlist, {
    ...
    routeProdDetailPage: (product) => rootLink(`/products/${product.urlKey}/${encodeSkuForUrl(product.sku)}`),
